...
2. [二分查找](计算机系统/数据结构与算法/算法/二分查找.md)
3. [递归](计算机系统/数据结构与算法/算法/递归.md)
4. [分而治之](计算机系统/数据结构与算法/算法/分而治之.md)
5. [回溯](计算机系统/数据结构与算法/算法/回溯.md)
6. [深度优先搜索](计算机系统/数据结构与算法/算法/深度优先搜索.md)
7. [宽度优先搜索](计算机系统/数据结构与算法/算法/宽度优先搜索.md)
8. [贪心算法](计算机系统/数据结构与算法/算法/贪心算法.md)
9. [动态规划](计算机系统/数据结构与算法/算法/动态规划.md)
